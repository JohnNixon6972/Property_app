                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  key: UniqueKey(),
                                  imageUrl:
                                      bookMarkedProperties[index].imageloc,
                                  height: 200,
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                          ...
                                          district: bookMarkedProperties[index]
                                              .district,
                                          ownerMail: bookMarkedProperties[index]
                                              .ownerMail,
                                          ownerPhoneNo:
                                          ...
                                          ownerName: bookMarkedProperties[index]
                                              .ownerName,
                                          propertyDescription:
                                              bookMarkedProperties[index]
                                                  .propertyDescription,
                                          noBathroom:
                                              bookMarkedProperties[index]
                                                  .bathRoom,
                                          noBedroom: bookMarkedProperties[index]
                                              .bedRoom,
                                          area:
                                              bookMarkedProperties[index].area,
                                          propertyImages:
                                              bookMarkedProperties[index]
                                                  .propertyImages,
                                          price:
                                              bookMarkedProperties[index].price,
                                          lenght: bookMarkedProperties[index]
                                              .lenght,
                                          width:
                                              bookMarkedProperties[index].width,
                                          constructionArea:
                                              bookMarkedProperties[index]
                                                  .constructionArea,
                                          ownerImgUrl:
                                              bookMarkedProperties[index]
                                                  .ownerImgUrl,
                                          cent:
                                              bookMarkedProperties[index].cent,
                                          face:
                                              bookMarkedProperties[index].face,
                                        ),
                                      ),
                                    );
                                  },
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      ...
                                      firestore
                                          ...
                                          .doc(userInfo.mobileNumber)
                                          .collection("BookMarkedProperties")
                                          .doc(bookMarkedProperties[index]
                                              .propertyName)
                                          .delete();
