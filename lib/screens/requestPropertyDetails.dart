...
class requestedPropertyDetails extends StatefulWidget {
  String fields = "";
  String subfields = "";
  requestedPropertyDetails({required this.fields, required this.subfields});
  @override
  State<requestedPropertyDetails> createState() =>
      _requestedPropertyDetailsState();
}

class _requestedPropertyDetailsState extends State<requestedPropertyDetails> {
  @override
