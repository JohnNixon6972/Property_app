                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          key: UniqueKey(),
                          imageUrl: unApprovedProperties[index].imageloc,
                          height: 200,
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => PropertyDetailsScreen(
                                  ...
                                  ownerPhoneNo:
                                      unApprovedProperties[index].ownerPhoneNo,
                                  type:
                                      unApprovedProperties[index].propertyType,
                                  category: unApprovedProperties[index]
                                      .propertyCategory,
                                  propertyAddress: unApprovedProperties[index]
                                      .propertyAddress,
                                  propertyTitle:
                                      unApprovedProperties[index].propertyName,
                                  to: unApprovedProperties[index].to,
                                  ownerName:
                                      unApprovedProperties[index].ownerName,
                                  propertyDescription:
                                      unApprovedProperties[index]
                                          .propertyDescription,
                                  noBathroom:
                                      unApprovedProperties[index].bathRoom,
                                  noBedroom:
                                      unApprovedProperties[index].bedRoom,
                                  area: unApprovedProperties[index].area,
                                  propertyImages: unApprovedProperties[index]
                                      .propertyImages,
                                  price: unApprovedProperties[index].price,
                                  lenght: unApprovedProperties[index].lenght,
                                  width: unApprovedProperties[index].width,
                                  constructionArea: unApprovedProperties[index]
                                      .constructionArea,
                                  ownerImgUrl:
                                      unApprovedProperties[index].ownerImgUrl,
                                  cent: unApprovedProperties[index].cent,
                                  face: unApprovedProperties[index].direction,
                                ),
                              ),
                            );
                          },
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    ...
                                                    setState(() {
                                                      ...
                                                      unApprovedPropertiesNames.remove(unApprovedProperties[index].propertyName);
                                                      firestore
                                                          .collection(
                                                              collection)
                                                          .doc(
